...
def update_grades(student, subject_grades):
    ...
    # grades 키가 이미 있다면 업데이트, 없다면 새로 생성
    if "grades" in updated_student:
        updated_student["grades"].update(subject_grades)
    else:
        updated_student["grades"] = subject_grades.copy()
